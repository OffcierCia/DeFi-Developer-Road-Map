...
- [Block Lottos OpenAPI](https://blocklottos.com/openapi.json) - Public Polygon/Base lottery, draw history, jackpot, ad size, and wallet-signed ticket transaction builder API.
